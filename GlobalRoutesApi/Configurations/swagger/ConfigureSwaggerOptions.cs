using GlobalRoutes.Api.Filters;
using Microsoft.AspNetCore.Mvc.ApiExplorer;
using Microsoft.Extensions.Options;
using Microsoft.OpenApi.Models;
using Swashbuckle.AspNetCore.SwaggerGen;

namespace GlobalRoutes.Api.Configurations.swagger
{
    public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
    {
        ...
        private static OpenApiInfo CreateOpenApiInfo(ApiVersionDescription description)
        {
            var info = new OpenApiInfo
            {
                Version = "v1.0.0Alpha",
                Title = "GlobalRoutes",
                Description = "GlobalRoutes API",
                Contact = new OpenApiContact
                {
                    Name = "GlobalRoutes",
                    Email = "nestorgt37@gmail.com",
                    Url = new Uri("https://github.com/nestor327/GlobalRoutesApi"),
                },
                License = new OpenApiLicense
                {
                    Name = "Use for GeoRutas products",
                }
            };
